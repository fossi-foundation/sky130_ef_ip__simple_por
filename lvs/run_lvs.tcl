...
set circuit1 [readnet spice ../netlist/layout/sky130_ef_ip__simple_por.spice]
set circuit2 [readnet spice $hvlib]

readnet spice ../netlist/schematic/sky130_ef_ip__simple_por.spice $circuit2

# debug on

lvs "$circuit1 sky130_ef_ip__simple_por" "$circuit2 sky130_ef_ip__simple_por" \
        $setupfile sky130_ef_ip__simple_por_comp.out
